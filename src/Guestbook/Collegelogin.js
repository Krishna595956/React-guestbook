...
export default function Login() {
    ...
    const handleLogin=(e)=>{
        ...
        const loginData= async ()=>{
            const response=await axios.post("http://localhost:5000/collegelogin",{email,password})
  ...
  return (
    ...
    <center><h3 className='display-6'>College Login</h3></center>
...
<div className='row'>
    <div className='col-6'>
    <div><p>Don't have an account?  <Link to='/collegeregister' id="reglink">Register</Link></p></div>
    </div>
